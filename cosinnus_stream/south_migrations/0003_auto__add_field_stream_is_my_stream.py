...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Stream.is_my_stream'
        db.add_column(u'cosinnus_stream_stream', 'is_my_stream',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Stream.is_my_stream'
        db.delete_column(u'cosinnus_stream_stream', 'is_my_stream')
