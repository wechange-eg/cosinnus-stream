...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Stream.last_seen'
        db.add_column(u'cosinnus_stream_stream', 'last_seen',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Stream.last_seen'
        db.delete_column(u'cosinnus_stream_stream', 'last_seen')
