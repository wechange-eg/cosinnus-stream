...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Stream.group'
        db.alter_column(u'cosinnus_stream_stream', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['cosinnus.CosinnusGroup']))

        # Changing field 'Stream.creator'
        db.alter_column(u'cosinnus_stream_stream', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'Stream.group'
        db.alter_column(u'cosinnus_stream_stream', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['cosinnus.CosinnusGroup'], on_delete=models.PROTECT))

        # Changing field 'Stream.creator'
        db.alter_column(u'cosinnus_stream_stream', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['auth.User']))
    ...
    models = {
        ...
        u'cosinnus_stream.stream': {
            'Meta': {'ordering': "[u'created']", 'unique_together': "((u'creator', u'slug'),)", 'object_name': 'Stream'},
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'cosinnus_stream_stream_set'", 'to': u"orm['auth.User']"}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'cosinnus_stream_stream_set'", 'null': 'True', 'to': u"orm['cosinnus.CosinnusGroup']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_my_stream': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'last_seen': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'media_tag': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['cosinnus.TagObject']", 'unique': 'True', 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
            'models': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
