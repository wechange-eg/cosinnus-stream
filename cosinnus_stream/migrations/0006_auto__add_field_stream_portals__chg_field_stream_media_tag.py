...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Stream.portals'
        db.add_column(u'cosinnus_stream_stream', 'portals',
                      self.gf('django.db.models.fields.CommaSeparatedIntegerField')(default=u'', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Stream.portals'
        db.delete_column(u'cosinnus_stream_stream', 'portals')
    ...
    models = {
        ...
        u'cosinnus_stream.stream': {
            ...
            'portals': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'default': "u''", 'max_length': '255', 'blank': 'True'}),
